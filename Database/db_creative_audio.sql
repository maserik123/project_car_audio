...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jan 2021 pada 12.06
...
INSERT INTO `tbl_pembayaran` (`id_pembayaran`, `total_pembayaran`, `bukti_pembayaran`, `nomor_resi`, `kurir_pengiriman`, `tgl_pembayaran`, `status_pembayaran`, `aktif`) VALUES
(1, 0, '', '', '', '0000-00-00', '', 1),
...
(11, 'WP - HL', 'Wiper Mobil Merk Helios', 125000, 185000, 48, 'Wiper', 'All', 'wphl12.jpg', 48, 4, 0),
(12, 'WP - DDF', 'Wiper Mobil Merk Dr D Fischer', 60000, 100000, 30, 'Wiper', 'All', 'wpddf2.jpg', 68, 6, 0),
...
INSERT INTO `tbl_transaksi` (`id_transaksi`, `id_produk`, `id_pembayaran`, `id_user`, `tgl_transaksi`, `qty_transaksi`, `total_transaksi`, `aktif`) VALUES
...
--
ALTER TABLE `tbl_transaksi`
  MODIFY `id_transaksi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
